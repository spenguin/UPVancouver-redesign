...
\MediaUpload\initialise();

function initialise()
{
    add_action('admin_init', '\MediaUpload\admin_init');
    add_action('save_post_show', '\MediaUpload\save_show_photos');
}

function admin_init()
{
    add_meta_box('show_dates_meta', 'Show Images:', '\MediaUpload\myplugin_render_metabox', 'show');
}
