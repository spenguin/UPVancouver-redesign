...
function upv_ticket_admin()
{
    if( isset($_GET['orderId']))
    {
        ...
        if( isset($_POST['add_order'] ))
        {
            ...
            {
                $error      = TRUE;
                $message    = "Date given is not a performance date for Show selected";
            }
        ...
        <div class="ticket-admin max-wrapper__narrow">
            <div class="ticket-admin__add">
                ...
                <form action="<?php echo $url ?>" method="post" class="upv-form">
                    ...
                    <?php 
                        $date = isset($_POST['performance_date']) ? $_POST['performance_date'] : ''; 
                        $time = isset($_POST['performance_time']) ? $_POST['performance_time'] : '';
                    ?>
                    ...
                    <label for="performance_time">Which performance time:&nbsp;<input type="time" name="performance_time" placeholder="Performance time" required value="<?php echo $time; ?>" /></label>
